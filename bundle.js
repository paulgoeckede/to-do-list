...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#sidebar {\n    height: 100%;\n    width: 20%;\n    background-color: #1f487e;\n}\n\n#headerContainer {\n    border-bottom: 1px solid white;\n    text-align: center;\n    padding: 10px;\n    height: 20%;\n}\n\n#headerContainer h2 {\n    font-weight: 500;\n    letter-spacing: 1px;\n    font-size: 32px;\n}\n\n#projects {\n    height: 80%;\n}\n\n#projectList {\n    list-style: none;\n    padding: 20px;\n}\n", "",{"version":3,"sources":["webpack://./src/styles/sidebar.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,UAAU;IACV,yBAAyB;AAC7B;;AAEA;IACI,8BAA8B;IAC9B,kBAAkB;IAClB,aAAa;IACb,WAAW;AACf;;AAEA;IACI,gBAAgB;IAChB,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB","sourcesContent":["#sidebar {\n    height: 100%;\n    width: 20%;\n    background-color: #1f487e;\n}\n\n#headerContainer {\n    border-bottom: 1px solid white;\n    text-align: center;\n    padding: 10px;\n    height: 20%;\n}\n\n#headerContainer h2 {\n    font-weight: 500;\n    letter-spacing: 1px;\n    font-size: 32px;\n}\n\n#projects {\n    height: 80%;\n}\n\n#projectList {\n    list-style: none;\n    padding: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony export */   "parseExistingTodos": () => (/* binding */ parseExistingTodos),
/* harmony export */   "addButton": () => (/* binding */ addButton),
/* harmony export */   "taskInput": () => (/* binding */ taskInput),
/* harmony export */   "tasksDiv": () => (/* binding */ tasksDiv)
/* harmony export */ });
/* harmony import */ var _manage_todos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage-todos */ "./src/scripts/manage-todos.js");
/* harmony import */ var _todo_overlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo-overlay */ "./src/scripts/todo-overlay.js");
...
function parseExistingTodos() {
    _manage_todos__WEBPACK_IMPORTED_MODULE_0__.todos.forEach((item) => {
        appendTodo(item);
    });
}
...
function appendTodo(todo) {
    ...
    newTodo.addEventListener("click", (e) => {
        if (e.target.className !== "checkbox") {
            (0,_todo_overlay__WEBPACK_IMPORTED_MODULE_1__["default"])(todo);
...
/* harmony export */   "changeDue": () => (/* binding */ changeDue),
/* harmony export */   "changeNote": () => (/* binding */ changeNote),
/* harmony export */   "addChecklistItem": () => (/* binding */ addChecklistItem),
/* harmony export */   "removeCheckListItem": () => (/* binding */ removeCheckListItem),
/* harmony export */   "save": () => (/* binding */ save),
/* harmony export */   "load": () => (/* binding */ load),
/* harmony export */   "todos": () => (/* binding */ todos)
/* harmony export */ });
/* harmony import */ var _todo_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo-class */ "./src/scripts/todo-class.js");
...
function createTodo(descr) {
    return new _todo_class__WEBPACK_IMPORTED_MODULE_0__["default"](descr);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ generateOverlay)
/* harmony export */ });
/* harmony import */ var _manage_todos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage-todos */ "./src/scripts/manage-todos.js");
...
function managePriority(one, two, three, prio, id) {
    ...
    (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.changePriority)(id, priority); //This changes the priority attribute of the todo object
}
...
function generateDueDate(todo) {
    ...
    if (todo.due) {
        ...
        dateInput.setAttribute("value", `${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.due, "yyyy-MM-dd")}`);
    }
    ...
    dateInput.addEventListener("input", () => {
        ...
        (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.changeDue)(todo.id, date); //change due date in todo object array
        document.querySelector(`[data-dateindex = "${todo.id}"]`).innerHTML =
            (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.due, "do MMM yyyy");
    });
...
function generateNotes(todo) {
    ...
    notesText.addEventListener("input", () => {
        (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.changeNote)(todo.id, notesText.value); //if note is input then save note in todo element
    });
...
function generateChecklist(todo) {
    ...
    todo.checklist.forEach((item) => {
        ...
        checkbox.addEventListener("click", () => {
            ...
            (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.removeCheckListItem)(todo.id, checkbox.nextElementSibling.innerHTML);
        });
    ...
    newItem.addEventListener("keyup", (e) => {
        if (e.key === "Enter") {
            (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.addChecklistItem)(todo.id, newItem.value);
            ...
            checkbox.addEventListener("click", () => {
                checkbox.parentElement.remove();
                (0,_manage_todos__WEBPACK_IMPORTED_MODULE_0__.removeCheckListItem)(
                    todo.id,
...
/* harmony import */ var _styles_sidebar_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/sidebar.css */ "./src/styles/sidebar.css");
/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/main.css */ "./src/styles/main.css");
/* harmony import */ var _scripts_manage_todos__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/manage-todos */ "./src/scripts/manage-todos.js");
/* harmony import */ var _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/dom-manager */ "./src/scripts/dom-manager.js");
...
_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.addButton.addEventListener("click", () => {
    const newTodo = _scripts_manage_todos__WEBPACK_IMPORTED_MODULE_3__.addTodo();
    _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.appendTodo(newTodo);
    _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.taskInput.value = "";
});

_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.taskInput.addEventListener("keyup", (e) => {
    if (e.key === "Enter") {
        const newTodo = _scripts_manage_todos__WEBPACK_IMPORTED_MODULE_3__.addTodo();
        _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.appendTodo(newTodo);
        _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_4__.taskInput.value = "";

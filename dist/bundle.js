...
function parseExistingTodos(id) {
    (0,_project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById)(id).todos.forEach((item) => {
        appendTodo(item);
    });
}
...
function appendTodo(todo) {
    ...
    todoCheckbox.addEventListener("click", () => {
        _project_manager__WEBPACK_IMPORTED_MODULE_0__.projects[currentProjectID].removeTodo(
            todoCheckbox.parentElement.parentElement.getAttribute("data-todoID")
        );
        todoCheckbox.parentElement.parentElement.remove();
        (0,_project_manager__WEBPACK_IMPORTED_MODULE_0__.save)();
    });
    ...
    if (todo.due) {
        datep.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.due, "do MMM yyyy");
    }
...
function switchProjects(projectID) {
    ...
    newHeader.innerHTML = (0,_project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById)(projectID).name;
    headerContainer.innerHTML = "";
    headerContainer.appendChild(newHeader);
    console.log((0,_project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById)(projectID));
...
function load() {
    ...
    projectsArr.forEach((project) => {
        projects.push(
            new _project_class__WEBPACK_IMPORTED_MODULE_0__["default"](
                project.name,
                project.id,
                project.todos,
                project.idCount
...
/* harmony export */ });
/* harmony import */ var _project_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project-manager */ "./src/scripts/project-manager.js");
/* harmony import */ var _dom_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom-manager */ "./src/scripts/dom-manager.js");
...
function newProject(name, id) {
    ...
    newText.addEventListener("click", () => {
        (0,_dom_manager__WEBPACK_IMPORTED_MODULE_1__.switchProjects)(newText.getAttribute("data-projectid"));
    });
...
function parseHeader() {
    ...
    header.innerHTML = _project_manager__WEBPACK_IMPORTED_MODULE_0__.projects[0].name;
    headerContainer.innerHTML = "";
...
function managePriority(one, two, three, prio, id) {
    ...
    _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(_dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID).changePriority(
        id,
        priority
    );
}
...
function generateDueDate(todo) {
    ...
    if (todo.due) {
        ...
        dateInput.setAttribute("value", `${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.due, "yyyy-MM-dd")}`);
    }
    ...
    dateInput.addEventListener("input", () => {
        ...
        _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(_dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID).changeDue(
            todo.id,
            date
        ); //change due date in todo object array
        document.querySelector(`[data-dateindex = "${todo.id}"]`).innerHTML =
            (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.due, "do MMM yyyy");
    });
...
function generateNotes(todo) {
    ...
    notesText.addEventListener("input", () => {
        _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(_dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID).changeNote(
            todo.id,
            notesText.value
...
function generateChecklist(todo) {
    ...
    todo.checklist.forEach((item) => {
        ...
        checkbox.addEventListener("click", () => {
            ...
            _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(_dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID).removeCheckListItem(
                todo.id,
    ...
    newItem.addEventListener("keyup", (e) => {
        if (e.key === "Enter") {
            _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(_dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID).addChecklistItem(
                todo.id,
                newItem.value
            );
            ...
            checkbox.addEventListener("click", () => {
                checkbox.parentElement.remove();
                _project_manager__WEBPACK_IMPORTED_MODULE_0__.getProjectById(
                    _dom_manager__WEBPACK_IMPORTED_MODULE_1__.currentProjectID
                ).removeCheckListItem(
                    todo.id,
                    checkbox.nextElementSibling.innerHTML
                );
...
/* harmony import */ var _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/dom-manager */ "./src/scripts/dom-manager.js");
...
/* harmony import */ var _scripts_project_manager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/project-manager */ "./src/scripts/project-manager.js");
...
_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.addButton.addEventListener("click", () => {
    const newTodo = _scripts_project_manager__WEBPACK_IMPORTED_MODULE_5__.projects[
        _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.currentProjectID
    ].addTodo(_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.taskInput.value);
    _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.appendTodo(newTodo);
    _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.taskInput.value = "";
});

_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.taskInput.addEventListener("keyup", (e) => {
    if (e.key === "Enter") {
        const newTodo = _scripts_project_manager__WEBPACK_IMPORTED_MODULE_5__.projects[
            _scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.currentProjectID
        ].addTodo(_scripts_dom_manager__WEBPACK_IMPORTED_MODULE_3__.taskInput.value);
